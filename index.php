<?php include('includes/header.php') ?>
  ...
  <div class="main-content">
      ...
      <div class="container-fluid p-0">
        ...
        <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
          ...
          <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/01.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/01.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/03.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/03.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0"
                  id="slide-2-layer-1"
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Welcome To <span class="text-theme-colored2">FET</span>
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                  id="slide-2-layer-3"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap;">FET is a highly recomended faculty of university of sindh jamshoro, pakistan<br> learn here to achieve.
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption rs-parallaxlevel-0"
                  id="slide-2-layer-4"
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="assets/images/bg/02.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="assets/images/bg/02.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0"
                  id="slide-3-layer-1"
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Best <span class="text-theme-colored2">Certified</span> Faculty
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                  id="slide-3-layer-3"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap;">PEC Certified ,<br> ISO 9001:2015 Certified
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption rs-parallaxlevel-0"
                  id="slide-3-layer-4"
    ...
    <!-- Section: welcome -->
    <section>
      <div class="container pt-50 news-cont">
        <div class="section-content">
          <div class="news-slider">
            <div class="ns-left">
              <h3> <i class="fa fa-bell"></i> Latest News</h3>
            </div>
            <div class="ns-right">
        ...
        <div class="section-title">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              ...
              <p class="text-white-f2 text-center">Our Faculty Of Enigneering and Technology is awarded with 189 awards with having highly qualified faculty member and we have 280 courses in FET which are underneath these skilled and highly qualified teachers</p>
            </div>
          </div>
        </div>
        <div class="section-content">
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
              ...
              <p>Our highly qualified , skilled faculty members.</p>
            </div>
          </div>
        </div>
